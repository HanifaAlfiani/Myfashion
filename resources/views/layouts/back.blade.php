...
<head>
  ...
  <title>@yield('title') / Myfashion</title>
    ...
    <div class="main-wrapper">
        ...
        <form class="form-inline mr-auto">
          ...
          <div class="search-element">
            ...
            <div class="search-result" id="searchResultMenu">
              ...
              <div class="search-item">
                <a href="{{ route('atasan-cms.index') }}" style="color: #78828a;">
                  <i class="fas fa-tshirt mr-1" style="width: 30px"></i>
                  Atasan
                </a>
              </div>
              <div class="search-item">
                <a href="{{ route('celana-cms.index') }}" style="color: #78828a;">
                  <i class="fas fa-window-maximize mr-1" style="width: 30px"></i>
                  Celana
                </a>
              </div>
              <div class="search-item">
                <a href="{{ route('outer-cms.index') }}" style="color: #78828a;">
      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li class="{{ request()->routeIs('atasan-cms.index') ? 'active' : '' }}"><a class="nav-link" @if(request()->routeIs('atasan-cms.index') && isset($primary_color)) style="color: {{$primary_color}};" @endif href="{{ route('atasan-cms.index') }}"><i class="fas fa-tshirt"></i> <span>Atasan</span></a></li>
              <li class="{{ request()->routeIs('celana-cms.index') ? 'active' : '' }}"><a class="nav-link" @if(request()->routeIs('celana-cms.index') && isset($primary_color)) style="color: {{$primary_color}};" @endif href="{{ route('celana-cms.index') }}"><i class="fas fa-window-maximize"></i> <span>Celana</span></a></li>
              <li class="{{ request()->routeIs('outer-cms.index') ? 'active' : '' }}"><a class="nav-link" @if(request()->routeIs('outer-cms.index') && isset($primary_color)) style="color: {{$primary_color}};" @endif href="{{ route('outer-cms.index') }}"><i class="fas fa-user-secret"></i> <span>Outer</span></a></li>
            </ul>
        </aside>
      </div>
      ...
      <footer class="main-footer">
        <div class="footer-left">
          Hak Cipta &copy; 2021 <div class="bullet"></div> <a href="{{ url('/') }}" @if(isset($primary_color)) style="color: {{$primary_color}}" @else style="color: #6777ef;" @endif>MYFASHION</a>
        </div>
      </footer>
    </div>
  </div>
